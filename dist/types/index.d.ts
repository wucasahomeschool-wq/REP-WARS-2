...
export type BattleOutcomeType = 'attacker_decisive_victory' | 'attacker_narrow_victory' | 'attacker_pyrrhic_victory' | 'defender_decisive_victory' | 'defender_narrow_victory' | 'defender_pyrrhic_victory' | 'mutual_heavy_losses' | 'stalemate';
export type TerritoryOutcome = 'unchanged' | 'captured' | 'contested' | 'retreat_required' | 'surrendered';
export type BattleEventType = 'phase_start' | 'first_strike' | 'charge' | 'rally' | 'rout' | 'breach' | 'flank' | 'ambush' | 'heroic_stand' | 'retreat' | 'surrender' | 'phase_end' | 'critical_hit';
