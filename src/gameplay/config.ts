...
export const GAMEPLAY_CONFIG = Object.freeze({
  ...
  cityCombatDefenseFactor: 1.25,
  citylessCombatDefenseFactor: 1.0,
  cityDefenseWorkoutBase: 1.5,
  citylessDefenseWorkoutFactor: 1.0,
  defenseWorkoutFortBonusPerLevel: 0.1,
  defenseWorkoutMultiplierCap: 2.0,
  farmGoldCost: 30,
  farmWoodCost: 20,
  farmConstructionDurationTicks: 20,
  mineGoldCost: 40,
  mineWoodCost: 25,
  mineConstructionDurationTicks: 20,
  lumberGoldCost: 30,
  lumberStoneCost: 20,
  lumberConstructionDurationTicks: 20,
});
